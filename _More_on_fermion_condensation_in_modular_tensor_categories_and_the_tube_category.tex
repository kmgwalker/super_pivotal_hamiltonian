...
\ethan{I did it, and it works, see above. If you guys are uncomfortable with writing the twists like that (I forget if we don't like it or not) I can do something else. Can also write down the $S$-matrix verification, but it's a bit tedious and un-illuminating.}

Note that if $J = B$ then replacing $b$ with $b\tp \psi$ changes the sign of the twist.
Since we can choose either $b$ or $b\tp\psi$ for the lift, this gives a sign ambiguity in the twist.
