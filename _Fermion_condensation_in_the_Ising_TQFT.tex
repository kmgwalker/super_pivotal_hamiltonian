...
%\dave{section reference doesn't exist, nor does the section. }
%\ethan{thanks for catching that!}
...
%\ee
%\dave{Made symbols for graphics.}
\begin{align}
...
or vice-versa; see [Scott and Kevin's paper]\dave{Should turn this into a citation. \dave{Dave will do this.}} for a discussion of this.}
...
%%KW seems OK to me now
%\kw{the above discussion needs improvement; KW will do}
...
%and significantly limits the types of theories that can have objects with $\cliff_1$ 
...
\vspace{3mm}
	...
	%\kw{in upper right, need to change 2 single arrows to one double arrow
	%\dave{Will fix top right figure.}
	%\dave{done}.}
	}  \label{C2_data_table}
\end{table}
