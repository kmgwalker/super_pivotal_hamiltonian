...
\dave{Why push this off to the appendix? I thought it was one of the purposes of this paper.} \ethan{Okay fine. I reserve the right to bitch about it later though} 
...
\dave{I'm fine with the notation. But why do you say that $f_i$ is just multiplication by a number? It's an odd operator so at the very least it changes the parity of the state.} 
...
\ethan{Are the Kozul signs appearing in the normal super pentagon equation begin left implicit here?}
