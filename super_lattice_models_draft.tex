...
The fact that the fusion vertices involving $Q$ type particles allow fermions to freely enter and exit the fusion space is reminiscent of superconductivity. \ethan{might need to explain this to me...}
...
\end{align}
for all $f \in \text{End}(x)$. \ethan{why do we have the $\circ$ symbol? Are we really composing a morphism with a vector?} This allows us to write down the correct version of \eqref{resid} as
\begin{align}
