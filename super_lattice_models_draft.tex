...
\end{tabular}
 ...
 %%%
 \begin{tabular}{  l | l }
   spin & $V^{\mathds{1}}_{\mathds{1}}$ \\ \hline
A &  1 \\ \hline
   A &  2 \tikzmark[xshift=3.5em]{a} \\ \hline
A &  1\tikzmark[xshift=3.5em]{b} \\ \hline
B &  1 \tikzmark[xshift=3.5em]{c}  \\ \hline
B &  2 \tikzmark[xshift=3.5em]{d} \\ \hline
 \end{tabular}
\drawcurvedarrow[bend left=60,-stealth]{a}{b}
\annote[right]{arrow-1}{Oddly isomorphic}
\drawcurvedarrow[bend left=60,-stealth]{c}{d}
\annote[right]{arrow-2}{Oddly isomorphic}
%%%
%%%

\begin{center}
\begin{tabular}{ c | c c | c c c c }
spin & $V^{\mathds{1}}_{\mathds{1}}$ & $V^{\rho \rho}_\mathds{1} \tp V^{\mathds{1} \rho}_\rho$ & $V^{\rho}_\rho$ & $V^{\rho \mathds{1}}_\rho \tp V^{\rho \rho}_\mathds{1}$ & $v_1\tp v_1$ & $v_1 \tp v_2$ \\ \hline
