...
\ethan{add some examples from here to above. Only restrict attention to endomorphism algebras, e.g. endos of trivial object is blah so splits as two idempotents, etc. Never write linear combinations 
of tubes with different boundary conditions}
