...
\end{cases}
\end{align}
The total squared dimension $\mcd^2$ of the theory is given by $ \langle S^2_\phi, S^2_\phi \rangle$, the inner product of the 2-sphere (empty boundary conditions) with itself.
