...
\mcd_{\tube(\mcc/\psi)}^2 = \mcd_\mcc^2 \mcd_{\mcc/\psi}^2 d_x^2 + d_{x \tp \psi}^2 + \sum_{x \in \sobq(\mcc/\psi) } d_x. 
\end{align}
...
\begin{align}
\mcd^2 = \sum_{x \sob(\mcc)} d_x^2 = \sum_{x \in \sobm(\mcc/\psi)}
\end{align}
...
See Section \ref{he6mp-tube-cat} for a further example of these tecchniques.
