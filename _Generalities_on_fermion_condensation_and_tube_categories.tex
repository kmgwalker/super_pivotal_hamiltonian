...
Recall that a trace on a super linear category $C$\dave{Was the $C$ on purpose or should we use $\mcc$ instead?} is a linear function from endomorphisms to $\cc$, satisfying
...
\end{align}
<<<<<<< HEAD
with $\mu_i$ denoting a complete basis of morphisms for $\mor(\unit \to x)$ (of course, if $x$ is 
simple this vector space is zero).
...
>>>>>>> 92141014287653fe98faf5c932bd8ff00e543210
