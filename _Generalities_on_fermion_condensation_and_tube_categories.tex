...
Letting $t \in \tube^W(\scat)$ and writing $\tr(t)$ for the trace of $t$, we can use \eqref{trace_to_innerproduct} to write
...
Let us see how this works out for a general super pivotal category $\scat$.
Let $x \in \sob(\scat)$, it follows that
\begin{align}
...
Let $x$ be a minimal idempotent of $\tube(\scat)$, 
