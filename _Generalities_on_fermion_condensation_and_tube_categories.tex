...
We now compute some examples.
\dave{Confused. I thought $\langle cl(x),cl(x) \rangle$ was the norm of $\text{id}_x$ but that doesn't seem right.
Will ask next time we Skype.}
