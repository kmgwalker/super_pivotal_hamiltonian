...
\dave{A possible caption.}
On the left we have a 3d box. 
The front of the 3d box is a 2d boundary where we have $\mcc$ string nets (viewed as a module for $\mcz(\mcc)$). 
...
On the right we have performed back wall condensation on $\psi \in \mcz(\mcc)$.
}
\end{figure} 
