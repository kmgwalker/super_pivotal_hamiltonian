...
\kw{I too have my doubts about the symmetry sentence.
I was trying to make contact with the familiar idea that particles are irreps of the symmetry group of a theory.}
...
%\kw{Dave and/or Ethan should double-check above formula}
%\dave{I got the same (after some confusion).
%I'm glad we're including it, it looks very nice.}
%\ethan{yeah, looks good. Have we defined $B_m$, $N_m$, $N_q$ anywhere? I guess it's self-explanatory, but maybe we should add the definition if not} 
%\kw{They are defined before (141)}
