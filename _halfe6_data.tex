...
There are four unitary solutions to the pentagon equation for $\frac{1}{2}$E6 fusion rules. 
...
\kw{I don't understand this last part}
\dave{Right, thanks. 
Should be consistent with the rest of the paper.
Should have been something like $W_\unit= w_{\unit y} \circ w_{y \unit} = w_{\unit x} \circ w_{x \unit}$, $W_x  =\cdots$, etc. 
I'll think about the notation before I make any drastic changes. 
}
%old notation
%\begin{align}
