...
We now define the 0-handle tensors $T_v$ as follow.
...
by
\be
	T_v(w_i\tp\cdots\tp w_k) = \widetilde{\text{Link}}(v, w_i\tp\cdots\tp w_k),
\ee
where $w_i\in V_i$.
In other words, $T_v$ evaluates the link graph with labels $w_1,\ldots,w_k$.
\kw{... end ``as follows"}
