...
Our goal in this subsection is to reinterpret \eqref{bos_tv_sum} as a tensor network and discuss various standardization options.
...
\kw{also still to do: fermionic state sum, fermionic tensor network, k-signs, spin pivots,
point out that spin-pivots encode the spin structure of the 3-manifold}
