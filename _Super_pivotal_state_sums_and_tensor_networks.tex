...
\ethan{edited caption and text}
\ethan{why $v_2 v_1 v_3$ and not $v_1v_2v_3$? Doesn't really matter though}
An example of how to compute the Koszul sign $(-1)^{\kappa_\beta}$ graphically 
