...
\dave{Looks like the KR citation may need to be fixed: \cite{kirillow1989,turaev1992shadow}, maybe \cite{turaev1990} (need to look at that again)\dave{Add Turaev's book. Remove 1991 ref.}}.
\dave{Fixed KR and added Turaev's book, removed the other two citations.}
