...
We now define the indicator \kw{??} function $\chi$, 
...
& \mu^* \tp \nu \mapsto \delta_{\mu\nu}.
\end{align}
\kw{Is this the canonical paring?  If yes, say so; if not, why not?}
...
I would say the output is a function from $A(\partial \mcm)$ to $\cc$.}
...
\kw{and orientations of 1- and 2-cells?}
\end{itemize}
