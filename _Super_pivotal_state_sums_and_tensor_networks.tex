...
\dave{Maybe change `value' to `amplitude': something like ``...we obtain the amplitude for the wave function of a given string net."}
...
As in the bosonic case, can standardize the tensor network by
