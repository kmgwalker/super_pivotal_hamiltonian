...
\end{center}
\caption{\dave{Was there meant to be some green in this figure? Make 0-handles green etc.}
...
Given a string net $g$ on $\Sigma$, we can define a wave function $\Psi_g$ via\dave{Will add a footnote for wavefunction.}
\be  \label{wfg-def}
