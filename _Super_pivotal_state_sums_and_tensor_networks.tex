...
\kw{What does it mean for a weight to be sign-ordered?  Do you mean the vertices in the evaluated string diagram are sign ordered? \dave{Yes.}}
...
Lastly, 
\kw{we already said ``finally" above}
