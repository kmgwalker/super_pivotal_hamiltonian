...
For a cell decompositions dual to a triangulation, these string nets take the form 
...
For a 0-handle $v$ we modify the associated weight ${\text{Link}}(v,\beta)$ by adding factors of $d(f,\beta)$ for each 2-handle $f$ such that $v = v_f$.
