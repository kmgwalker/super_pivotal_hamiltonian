...
\be T_v = \sum_{w_v \in \mch(v)} \widetilde{\text{Link}}(v,w_v) w_v,\ee
...
Formally, the partition function 
...
With the spin framing at the 0-handles fixed by virtue of the pitchforkization procedure, 
