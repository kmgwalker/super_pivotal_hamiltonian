...
\end{center}
\caption{\dave{Was there meant to be some green in this figure?}
...
$(-1)^{\kappa_\beta}=-1$).
\kw{Should the $v_1$ and $v_2$ labels be swapped?}
...
\begin{align}
\Tensora \; \ra T_v &= \;  \Tensorcc \cdot \mu_0 \tp s_1 \tp s_2 \tp s_3.
\end{align}
