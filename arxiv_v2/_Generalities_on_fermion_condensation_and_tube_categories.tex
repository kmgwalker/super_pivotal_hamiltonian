...
Objects in the condensed theory are inherited from the parent theory.
Similarly, morphisms of the condensed theory are defined via morphisms in the parent theory.
As a vector space, they are given by
\begin{align}
\mor_{\mcc/\varphi}(a \to b) \cong \mor_\mcc(a \to b \tp \varphi).
\end{align}
