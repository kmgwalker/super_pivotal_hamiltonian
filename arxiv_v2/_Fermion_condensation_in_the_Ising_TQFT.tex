...
we show how to condense $\psi$ in the Ising theory, obtaining the $C_2$ super pivotal theory, \ethan{which is a 1+1-dimensional fermionic fusion theory.}\dave{Looks good.} 
...
In this subsection we describe our procedure for condensing $\psi$ in the Ising theory. \ethan{Again, the 
motivation for doing this is to produce an example of a fermionic fusion theory, which we can later
input into a generalized string-net model to construct an example of a 2+1-dimensional fermionic topological 
phase.}
\dave{Sounds good.}
