...
condensed theory ``looses'' the braiding of the parent theory, and thus the condensed theory only describes 
...
string-net model which produces a braided (2+1-dimensional) fermionic topological phase (see below). }
