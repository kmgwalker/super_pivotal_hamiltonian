...
\spc & = \text{super pivotal tensor category}\\
\sob(\mcc) & = 
\begin{cases} 
...
\\
\cl(x) &= \text{closure of $x$ in either an annulus or torus depending on context}\\
\cl_W(x) &= \text{closure of $x$ with spin structure $W$ assigned to new cycle}\\
\nonumber\\
