...
\begin{longtabu}{|X[1,$c]|X[4,l]|}
	...
	\mch(Y)	& same as $A(Y)$ \ethan{Looks like this has been discontinued. The only place we use $\mch$ for Hilbert space is in the Hamiltonian section, where we write $\mch_v$ and stuff. Can we delete this entry?} \\ \hline
