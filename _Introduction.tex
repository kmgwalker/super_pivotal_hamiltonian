...
\ethanx{may not be needed: That is, we will show how to pass from a bosonic phase described by $\mcc$ to a phase where $\psi$ is a {\it local} (as opposed to an anyonic) excitation\davex{Again it sounds weird to call $\psi$ local.}.}
\ethanx{I mean, it's local in the sense that free fermions are local}
...
\kw{last sentence sounds odd to me.  can we be more specific?}
