...
The only pre-requisite for this section is a brief reading of Section \ref{C2_condense_sect}, and physically-inclined readers less interested in more general mathematical frameworks
...
\begin{longtabu}{|X[1,$c]|X[4,l]|}
    ...
    \cc^{r|s} & Super vector space with $r$ $(s)$ even (odd) generators \\ \hline
