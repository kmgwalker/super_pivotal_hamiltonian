...
That is, we will show how to pass from a bosonic phase described by $\mcc$ to a phase where $\psi$ is a {\it local} (as opposed to an anyonic) excitation\davex{Again it sounds weird to call $\psi$ local.}.
\ethan{I mean, it's local in the sense that free fermions are local}
...
It differs most significantly from the Levin-Wen Hamiltonian the presence of an edge term\davex{grammer.}
\ethan{What grammar? I changed the wording though. Also you misspelled grammar}, which 
