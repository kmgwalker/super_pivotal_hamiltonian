...
\mcc &= \text{tensor category}\ethan{I think we should explicitly say that $\mcc$ is a generic (super or non-super) tensor category.}\\
...
Z(Y) & = \text{Partition function on $Y$; equivalently the space of functions $Z(Y):A(Y)\ra \cc$}\\
\\
