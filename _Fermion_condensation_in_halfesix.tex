...
\caption{\label{rhotoe} A complete basis of morphisms $\mor(\rho \ra e) \in  \tube(\halfesix) $ and $\mor(e \ra \rho) \in  \tube(\halfesix) $.
...
a basis for which is listed in Table \ref{etorho}. \ethan{missing $e\ra \rho$ tadpole table}
