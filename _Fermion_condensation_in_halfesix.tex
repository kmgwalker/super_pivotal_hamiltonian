...
and (as we have seen before in \ref{C2etoe}) there is only one possible super algebra structure on $\cc^{2|0}$ given by $\cc \oplus \cc$ (as before $\cc$ is shorthand for the 1-dimensional even algebra).
...
which a basis is listed in table \ref{etorho}. \ethan{missing $e\ra \rho$ tadpole table}
...
One may think that it could just have easily been $Q(1)$, 
