...
>>>>>>> bd45b199f3549180c3a26b6ea265726a7de99eb8
...
$q_\unit $&$(1+i\bullet)q_\unit$& e^{-i\pi/8}(1-i \bullet)	{q_\sigma} $&$(1+i \bullet)q_\psi$&$e^{-i\pi/8}(1+i \bullet)m_\unit$&$(1-i \bullet )m_\sigma^+$&$e^{- i\pi/8}(1+i \bullet)m_\psi$\\
\hline
<<<<<<< HEAD
...
$q_\psi $&$(1+i\bullet)q_\psi$&$e^{-i\pi/8}(1{\pm}+i\bullet)q_\sigma$&$(1+i \bullet)q_\unit$&$-e^{-i\pi/8}(1+i\bullet)m_\psi$&$(1-i\bullet )m_\sigma^+$&$-e^{-i\pi/8}(1+i \bullet)m_\psi$
\end{tabular}
}\\ \ \\
