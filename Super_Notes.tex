...
\section{your mom: Background material} 
...
The table of values will denote the left column braiding over the top as shown in:
\begin{tabular}{c|c}
     & B\\
     \hline
A     & $R^{AB}_{A\otimes B}$
...
\hline
$q_\sigma $&$(1+i\bullet)q_\sigma$&$e^{i\pi/4}(1-i \bullet)q_\unit$&$(1-i\bullet)q_\sigma$&$(-e^{-i\pi/4}+i\bullet )m_\sigma^+$&$(1+i\bullet) m_\unit$&$(e^{-i \pi/4}+i \bullet)m_\sigma^+$ \\
...
%\be [R^{m^\pm_\sigma^\pm_\sigma}_\unit]^0 = \pm e^{i\pi/8},\ [R^{\pm\pm}_{m_\psi}]^1 = \pm (-i)e^{i\pi/8}\ee
