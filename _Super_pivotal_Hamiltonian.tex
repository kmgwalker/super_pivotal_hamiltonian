...
\dave{Ethan, can you double check this again? 
...
&\times \Plaquetteg
\end{align}
The pairing $\mcb$ is diagonal which allows which means $\mcb(\sigma_6 \tp \sigma_0)$ is zero, unless $\sigma_6$ is dual to $\sigma_0$
