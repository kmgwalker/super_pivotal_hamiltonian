...
%(i.e. elements 
%\kw{``elements" doesn't seem like the right word}
%of $\tube^N$) 
and deconfined anyonic excitations %(i.e.\ elements of $\tube^B$).
...
%\dave{Maybe we should say `...reproduces the correct $S$-matrix for $\tube(C_2)$, some ....'}
While we have checked that the computation of double braids reproduces the correct $S$-matrix for $\tube(C_2)$,
%in the tube algebra of the $C_2$ theory,
...
%assertive claims and speculations about mathematical things and musings on the general nature of fermionic theories
\begin{comment}
...
parent theories $\mcc$. 
\kw{I'm not comfortable with some of the statements in this paragraph}

\kw{I also think it might be better not to speculate as in this paragraph}
...
Dave Aasen thanks Parsa Bonderson for explaining his un-published work at early stages of this project. 
