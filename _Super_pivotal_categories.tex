...
\kw{That's probably it; see also the two references at the end of the wikipedia article: https://en.wikipedia.org/wiki/Dual\_object;
...
\ethan{right, the $\mu^*$ should be on the left. Left-to-right koszul ordering is correct though.}
...
\end{align}
for objects $a,b$ and morphisms $\alpha,\beta$. \ethan{added the following to make things a little more friendly:} Diagrammatically, the $r$ 
