...
A {\it reflection structure} on $\spc$ is an anti-linear anti-automorphism $r$ from $\spc$ to itself which preserves (rather than reverses) 
...
\kw{still to do: explain how this works, explain why hamiltonian is hermetian}

\kw{still to do: say that $\mcc/\psi$ has a pin+ rs if xxxx}
