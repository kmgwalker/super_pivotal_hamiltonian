...
Let $\mct$ denote the tube category, and let $x$ be an object
...
In bosonic theories $V^{ab}_c \cong \Delta^{ab}_c$, but in fermionic theories the fusion spaces 
...
We will see that this naive guess is incorrect: instead, for each spin structure, 
