...
We seek an MPO that projects a given wavefunction \ethan{wavefunction or state? Maybe I'm being too picky} into the image of the projectors $H_i$ defined in \eqref{kitaev_chain_ham_sitei}. 
...
If $b_l=f$ ($b_r=f$), and additional fermionic dot is present on the left side of the first interval (right side of the last interval). 
