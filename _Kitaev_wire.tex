...
\dave{$\mca$ seems more natural to me so lets go with that,
 ...
 \dave{Ugh. Should have been $A$ rather than $\mca$.
 Will fix now.}
\be\label{VIbetabeta}
...
To better understand the wavefunctions $\Psi_e,\Psi_o$, we can apply ana series of F-move's to change back to our physical ``on-site" basis. \footnote{Recall the physical Hilbert space is asscociated to $A(I_i,\beta, \beta)$, 
