...
We seek an MPO that projects a given wavefunction \ethan{wavefunction or state? Maybe I'm being too picky\dave{either is fine with me.}} into the image of the projectors $H_i$ defined in \eqref{kitaev_chain_ham_sitei}. 
