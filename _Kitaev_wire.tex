...
where as usual $A(Y)$ denotes string-nets modulo local relations on $Y$ \ethan{slightly misleading since we usually write $A(Y)$ but now we're specifying a string-net boundary condition}\dave{True.}.
