...
\ethan{the following should be better / less wordy and more mathy}
...
be disallowed, since the number of Majorana zero modes be preserved modulo 2. \ethan{do we even want to mention the above paragraph? More importantly, is it correct? Dave probably knows this best}
